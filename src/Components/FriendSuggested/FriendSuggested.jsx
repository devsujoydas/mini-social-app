              ...
              <Link to={`/friends/${youMayKnowFriends[0]?.username}`} className="flex w-full justify-between items-center">
                <div className="flex items-center gap-3">
                  <div className="active:scale-95 transition-all cursor-pointer">
                    <img className="w-10 h-10 object-cover rounded-full" src={!youMayKnowFriends[0]?.profilephotourl ? `/default.jpg` : `${youMayKnowFriends[0]?.profilephotourl}`} alt="" />
                  </div>
                  <div>
...

          {
            ...
            <div>
              <Link to={`/friends/${youMayKnowFriends[1]?.username}`} className="flex w-full justify-between items-center">
                <div className="flex items-center gap-3">
                  <div className="active:scale-95 transition-all cursor-pointer">
                    <img className="w-10 h-10 object-cover rounded-full" src={!youMayKnowFriends[1]?.profilephotourl ? `/default.jpg` : `${youMayKnowFriends[1]?.profilephotourl}`} alt="" />
                  </div>
                  <div>
...

          {
            ...
            <div>
              <Link to={`/friends/${youMayKnowFriends[2]?.username}`} className="flex w-full justify-between items-center">
                <div className="flex items-center gap-3">
                  <div className="active:scale-95 transition-all cursor-pointer">
                    <img className="w-10 h-10 object-cover rounded-full" src={!youMayKnowFriends[2]?.profilephotourl ? `/default.jpg` : `${youMayKnowFriends[2]?.profilephotourl}`} alt="" />
                  </div>
                  <div>
