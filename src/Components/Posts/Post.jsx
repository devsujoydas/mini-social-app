  ...
  return (
    <div className="shadow-xl border-t border-t-zinc-300 md:w-full rounded-2xl md:rounded-3xl bg-white">
      ...
      <form className="p-3 md:p-4 flex justify-between items-center gap-2 md:gap-20">
        ...
        <div className="flex items-center gap-3">
          <ImAttachment className="border border-zinc-400 p-2 md:p-3 rounded-full cursor-pointer active:scale-95 transition-all hover:bg-zinc-200" />
          <FaRegSmile className="border border-zinc-400 p-2 md:p-3 rounded-full cursor-pointer active:scale-95 transition-all hover:bg-zinc-200" />
          <VscSend className="border border-blue-700 text-blue-700 p-2 md:p-3 rounded-full cursor-pointer active:scale-95 transition-all hover:bg-blue-600" />
        </div>
      </form>
    </div>
  );
