...
const ProfileSideTop = () => {
    ...
    return (
        <div className='w-full bg-white rounded-lg'>
            ...
            <div className='lg:px- md:px-8  flex lg:flex-row flex-row md:flex-col gap-3 lg:justify-between md:justify-center  items-center'>
