...
const Login = () => {
    ...
    const from = location.state?.from?.pathname || "/profile"; // 🔁 Redirect to original route or fallback
        ...
        logInUser(email, password)
            .then((result) => {
                if (result.user.email) {
                    ...
                    navigate(from, { replace: true }); // ✅ Redirect here
                }
            })
            .catch((err) => {
                ...
                <div className="h-full flex justify-center items-center">
                    <div className="md:space-y-10 space-y-8 lg:w-2/4 w-full">
                        ...
                        <div className="flex justify-center flex-col gap-5 items-center">
                            <form onSubmit={submitHandler} className="w-full space-y-4">
                                ...
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center">
                                        ...
                                        <label htmlFor="remember-me" className="text-black font-semibold ml-3 block text-sm cursor-pointer">Remember me</label>
                                    </div>
                                    <div>
                            ...
                            <p className="text-slate-800 text-sm text-center">Don't have any account?
