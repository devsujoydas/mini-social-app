    ...
    return (
        <>
            ...
            <div className="border p-3 bg-white border-zinc-300 rounded-lg">
                ...
                <div className="flex justify-center items-center gap-2 text-sm">
                    <button className='mt-3 font-semibold bg-zinc-200 hover:bg-zinc-300 active:scale-95 cursor-pointer w-full py-2 rounded-sm transition-all'>List View</button>
                    <button className='mt-3 font-semibold bg-zinc-200 hover:bg-zinc-300 active:scale-95 cursor-pointer w-full py-2 rounded-sm transition-all'>Grid View</button>
                </div>
            </div>
