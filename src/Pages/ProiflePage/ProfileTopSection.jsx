        ...
        <div className='w-full bg-white rounded-lg'>
            ...
            <div className='lg:px-20 md:px-8  flex lg:flex-row flex-row md:flex-col gap-3 lg:justify-between md:justify-center  items-center'>
                ...
                <div className='flex  gap-1 md:gap-3 lg:flex-row flex-col md:items-center md:p-0 p-3 '>
                    ...
                    <div className="">
                        <h1 className='md:text-3xl text-2xl font-bold'>Sujoy Das  <span className=''>(Ovi)</span></h1>
                        <p className='text-sm mt-1  font-medium text-zinc-500'><a className='hover:underline' href=""><span className="text-black font-semibold">2.7K</span> followers</a> • <a className='hover:underline' href=""><span className="text-black font-semibold">556</span> following</a></p>
                    </div>

                    <div className="block md:hidden">
                        <p className='text-zinc-600 text-sm mt-2'>Professional Web Developer || Software Engineers</p>
                    </div>
                </div>
